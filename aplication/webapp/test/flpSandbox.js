		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Work Docs",
									"targetURL": "#swdaplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"swdaplication-display": {
								"semanticObject": "swdaplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=swd.aplication",
									"url": sap.ui.require.toUrl("swd/aplication")
								}
							}
						}
					}
